...
# question 2: Write a query for extracting the data from the order table for the
...
# question 3: From orders retrieve only ord_no, purch_amt, ord_date, ord_date,
...
# question 4: Write a query to create a report with the order date in such a way
...
# question 5: Retrieve ord_no, purch_amt, ord_date, ord_date, salesman_id from
